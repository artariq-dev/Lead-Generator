...
export const calculators: Record<string, CalculatorConfig> = {
  growth: {
    ...
    tagline: "Is your business set up to grow — or are the gaps quietly holding you back?",
    description: "8 questions to find out if your software, outreach, and spending are working for your growth — or against it.",
    categories: [
      { id: "outreach", label: "Outreach & Visibility" },
      { id: "visibility", label: "Spend & Conversion" },
      { id: "automation", label: "Automation" },
      { id: "investment", label: "Investment Direction" },
    ],
    questions: [
      {
        id: "software_growth",
        label: "Is your software actively helping you get more customers — or is it just a tool you use internally?",
        options: [
          { label: "Actively brings in customers — it's a growth engine", value: "growth_engine", score: 5 },
          { label: "It helps, but it's not a major driver", value: "minor_help", score: 3 },
          { label: "It's mostly internal — customers don't really touch it", value: "internal", score: 0 },
          { label: "I haven't thought about it that way", value: "dont_know", score: -1 },
        ],
      },
      {
        id: "ad_spend",
        label: "When you run ads, do you know exactly which ones bring in paying customers — or are you guessing?",
        options: [
          { label: "Yes — I track exactly which ads convert", value: "tracked", score: 5 },
          { label: "I have a rough idea but not exact numbers", value: "rough", score: 3 },
          { label: "I run ads but don't really track ROI", value: "untracked", score: 0 },
          { label: "I don't run ads yet", value: "no_ads", score: -1 },
        ],
      },
      {
        id: "outreach_speed",
        label: "When someone shows interest in your business online, how long before they hear back from you?",
        options: [
          { label: "Minutes — it's automated", value: "minutes", score: 5 },
          { label: "Within the hour — I'm on it", value: "hour", score: 3 },
          { label: "Same day if I remember to check", value: "same_day", score: 0 },
          { label: "Days — it slips through sometimes", value: "days", score: -1 },
        ],
      },
      {
        id: "manual_work",
        label: "How much of your day do you spend on things like copy-pasting data, chasing follow-ups, or updating spreadsheets — tasks that feel like they should just run themselves?",
        options: [
          { label: "Almost none — most of it is automated", value: "automated", score: 5 },
          { label: "An hour or so — manageable", value: "some", score: 3 },
          { label: "A few hours — it adds up", value: "several_hours", score: 0 },
          { label: "Half my day or more — it's killing my productivity", value: "most_of_day", score: -1 },
        ],
      },
      {
        id: "growth_investment",
        label: "In the last 6 months, where has most of your growth budget gone — and did it actually move the needle?",
        options: [
          { label: "Clear ROI — I know what worked and doubled down", value: "clear_roi", score: 5 },
          { label: "Some wins, some misses — still figuring it out", value: "mixed", score: 3 },
          { label: "Hard to tell — results were murky", value: "murky", score: 0 },
          { label: "I haven't had a real growth budget to speak of", value: "no_budget", score: -1 },
        ],
      },
      {
        id: "conversion_visibility",
        label: "Do you know where potential customers drop off before buying — or is that a black box?",
        options: [
          { label: "Yes — I track the full journey and fix drop-off points", value: "tracked", score: 5 },
          { label: "I have a rough idea of where I lose people", value: "rough", score: 3 },
          { label: "I know I lose people but not where or why", value: "unknown", score: 0 },
          { label: "I have no visibility into this at all", value: "none", score: -1 },
        ],
      },
      {
